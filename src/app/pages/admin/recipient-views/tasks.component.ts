...
export class TasksComponent implements OnInit {
  ...
  tableData: Array<any>;
    ...
    ngOnInit(): void {
      this.buildForm();
      this.loadData();
      // this.tableData = [{name:"test Tasks a"},{name:"test Tasks b"},{name:"test Tasks c"}];
      this.loading = false;
    ...
    loadData(){
      let sql ="select Description as name,recordNumber from DataDomains where Domain='Task' ";
      this.loading = true;
