...
export class FillingclassificationComponent implements OnInit {
   ...
   constructor(
    ...
    loadData(){
      this.loading = true;
      this.menuS.getDataDomainByType("FILECLASS",this.check).subscribe(data => {
        this.tableData = data;
        this.loading = false;
      });
    }
    ...
    generatePdf(){
      ...
      var fQuery = "SELECT ROW_NUMBER() OVER(ORDER BY recordNumber) AS Field1,Description as Field2,CONVERT(varchar, [enddate],105) as Field3 from DataDomains "+this.whereString+" Domain='FILECLASS'";
      ...
      const data = {
        ...
        "options": {
          "reports": { "save": false },
          "txtTitle": "Filling Classification List",
          "sql": fQuery,
