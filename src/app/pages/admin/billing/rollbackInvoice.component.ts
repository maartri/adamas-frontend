...
@Component({
    ...
    templateUrl: './rollbackInvoice.component.html',
    styles: [`
  .mrg-btm{
...
export class RollbackInvoiceComponent implements OnInit {
    ...
    title: string = "Rolling Back Invoice Batch";
    ...
    loadInvoiceBatch() {
        this.loading = true;
        this.billingS.getInvoiceBatch().subscribe(data => {
            this.batchList = data;
    ...
    rollBackBatch() {
        ...
        this.billingS.rollbackInvoiceBatch({
            ...
            takeUntil(this.unsubscribe)).subscribe(data => {
                if (data) {
                    ...
                    this.globalS.sToast('Success','The Invoice Batch # ' + this.selectedBatch + ' has been rolled back successfully.');
    ...
    rollBack() {
        ...
        if (this.selectedBatch != '') {
            this.confirmModal = this.modal.confirm({
                ...
                nzContent: 'This process cannot be undone. <br> Are you sure you want to undo the changes made to the roster(s) under Invoice-Batch #: ' + this.selectedBatch + ' ?',
                nzOnOk: () => {
            ...
            this.globalS.eToast('Error', 'Please select Invoice Batch to Rollback.')
        }
    }
}
