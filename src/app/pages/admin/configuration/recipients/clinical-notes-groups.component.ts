...
export class ClinicalNotesGroupsComponent implements OnInit {
  ...
  tableData: Array<any>;
    ...
    loadData(){
      let sql ="SELECT ROW_NUMBER() OVER(ORDER BY Description) AS row_num, Description as name,recordNumber from DataDomains where Domain='CLINNOTEGROUPS' ";
      this.loading = true;
    ...
    generatePdf(){
      ...
      var fQuery = "SELECT ROW_NUMBER() OVER(ORDER BY Description) AS Field1,Description as Field2 from DataDomains where Domain='CLINNOTEGROUPS'";
