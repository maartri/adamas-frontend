...
export class StaffPositionsComponent implements OnInit {
    ...
    ngOnInit(): void {
      this.buildForm();
      this.loadData();
      // this.tableData = [{name:"test Staff Positions a"},{name:"test Staff Positions b"},{name:"test Staff Positions c"}];
      this.loading = false;
    ...
    loadData(){
      let sql ="select Description as name,recordNumber from DataDomains where Domain='STAFFPOSITION' ";
      this.loading = true;
