...
export class HealthConditionsComponent implements OnInit {
  ...
  temp_title: any;
    ...
    loadData(){
      this.loading = true;
      this.menuS.getDataDomainByType("HEALTH CONDITIONS",this.check).subscribe(data => {
        this.tableData = data;
        this.loading = false;
      });
    }
            ...
            this.inputVariables = {
              ...
              if (data)
              {
                this.timeS.postaudithistory({
                  ...
                  auditDescription:'Health Conditions Changed',
                  actionOn:'HEALTH CONDITIONS',
          ...
          .pipe(takeUntil(this.unsubscribe)).subscribe(datas => {
            if (datas) {
              this.timeS.postaudithistory({
                Operator:this.tocken.user,
                actionDate:this.globalS.getCurrentDateTime(),
                auditDescription:'Health Conditions Deleted',
                actionOn:'HEALTH CONDITIONS',
