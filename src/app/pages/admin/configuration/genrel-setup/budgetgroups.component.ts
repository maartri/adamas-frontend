  ...
  constructor(
    ...
    save() {
      ...
      if(!this.isUpdate){         
            ...
            this.inputVariables = {
              ...
              if (data)
              {
                this.timeS.postaudithistory({
                  ...
                  auditDescription:'Activity Budget Group Changed',
                  actionOn:'BUDGETGROUP',
        ...
        loadData(){
          this.loading = true;
          this.menuS.getDataDomainByType("BUDGETGROUP",this.check).subscribe(data => {
            this.tableData = data;
            this.loading = false;
          });
        }
          ...
          .pipe(takeUntil(this.unsubscribe)).subscribe(datas => {
            if (datas) {
              this.timeS.postaudithistory({
                Operator:this.tocken.user,
                actionDate:this.globalS.getCurrentDateTime(),
                auditDescription:'Activity Budget Group Deleted',
                actionOn:'BUDGETGROUP',
